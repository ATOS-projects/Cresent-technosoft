                ...
                <Container>
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        <div className="text-left max-w-2xl">
                            <div className="w-16 h-16 bg-blue-950 rounded-sm flex items-center justify-center mb-6 shadow-lg">
                            ...
                            <div className="flex flex-col sm:flex-row items-center gap-4">
                                <Link href="/contact">
                                    <button className="px-8 py-4 bg-blue-950 text-white font-semibold rounded-sm hover:bg-blue-900 shadow-lg hover:shadow-xl transition-all w-full sm:w-auto text-center">
                                        Request a Demo
                                    </button>
                                </Link>
                                <Link href="/contact">
                                    <button className="px-8 py-4 bg-white text-blue-950 font-semibold rounded-sm border-2 border-blue-900 hover:bg-slate-50 transition-all w-full sm:w-auto text-center">
                                        Contact Sales
                                    </button>
                                </Link>
                            </div>
