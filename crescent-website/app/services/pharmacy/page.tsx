...
export default function PharmacyPage() {
    ...
    return (
        <div className="min-h-screen bg-white">
            {/* Hero Section */}
            <div className="bg-gradient-to-br from-green-50 via-white to-emerald-50 pt-24 md:pt-32 pb-16">
                <Container>
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 shadow-lg hover:shadow-xl transition-all">
                                    Request a Demo
                                </button>
                            </Link>
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-white text-green-600 font-semibold rounded-lg border-2 border-green-600 hover:bg-green-50 transition-all">
                                    Contact Sales
                                </button>
                            </Link>
                        </div>
            ...
            <Container className="py-16 md:py-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {modules.map((module, index) => {
                        ...
                        return (
                            <div key={index} className="bg-white rounded-xl border-2 border-green-100 hover:border-green-300 p-6 hover:shadow-lg transition-all group">
            ...
            <div className="bg-gradient-to-br from-green-50 to-white py-16 md:py-20">
                <Container>
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                            Key Benefits
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {benefits.map((benefit, index) => (
                            <div key={index} className="flex items-start gap-3 bg-white rounded-lg border border-green-200 p-4 hover:border-green-400 hover:shadow-md transition-all">
            ...
            <Container className="py-16 md:py-20">
                ...
                <div className="bg-gradient-to-br from-green-50 to-white rounded-2xl border-2 border-green-100 p-8 md:p-12 shadow-lg">
            ...
            <div className="bg-gradient-to-br from-green-600 to-green-700 py-16 md:py-20">
                <Container>
                    <div className="text-center text-white max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href="/contact">
                                <button className="px-8 py-4 bg-white text-green-600 font-semibold rounded-lg hover:bg-green-50 shadow-lg hover:shadow-xl transition-all flex items-center gap-2">
                                    <span>Contact Us Now</span>
                                    <FaArrowRight />
                                </button>
                            </Link>
                            <Link href="tel:+914442865141">
                                <button className="px-8 py-4 bg-green-800 text-white font-semibold rounded-lg border-2 border-white/30 hover:bg-green-900 hover:border-white transition-all flex items-center gap-2">
                                    <FaPhone />
